...
**Решение:**
- Убедитесь, что в настройках домена указаны правильные порты:
  - Client: 5173 (это внешний порт из docker-compose)
  - Server: 8080 (это внешний порт из docker-compose)
- Проверьте, что контейнеры запущены и healthy
