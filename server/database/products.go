...
func GetAllProducts() ([]models.Product, error) {
	rows, err := db.Query(`SELECT id, name, volume, brand, default_tags, user_id FROM products`)
	if err != nil {
...
func GetProductById(id models.ProductId) (*models.Product, error) {
	var p models.Product
	var defaultTagsStr string
	err := db.QueryRow(`SELECT id, name, volume, brand, default_tags, user_id FROM products WHERE id = $1`, id).
...
func CreateProduct(product *models.Product) error {
	...
	err := db.QueryRow(`INSERT INTO products (name, volume, brand, default_tags, user_id) VALUES ($1, $2, $3, $4, $5) RETURNING id`,
...
func UpdateProduct(product *models.Product) error {
	defaultTagsStr := strings.Join(product.DefaultTags, ",")
	result, err := db.Exec(`UPDATE products SET name=$1, volume=$2, brand=$3, default_tags=$4 WHERE id=$5 AND user_id=$6`,
...
func DeleteProduct(id models.ProductId, userId models.UserId) error {
	result, err := db.Exec(`DELETE FROM products WHERE id = $1 AND user_id = $2`, id, userId)
	if err != nil {
