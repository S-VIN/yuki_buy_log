...
func (d *DatabaseManager) GetAllProducts() ([]models.Product, error) {
...
func (d *DatabaseManager) GetProductById(id models.ProductId) (*models.Product, error) {
	var p models.Product
	var defaultTagsStr string
...
func (d *DatabaseManager) CreateProduct(product *models.Product) error {
...
func (d *DatabaseManager) UpdateProduct(product *models.Product) error {
	defaultTagsStr := strings.Join(product.DefaultTags, ",")
...
func (d *DatabaseManager) DeleteProduct(id models.ProductId, userId models.UserId) error {
